...
fun ComposeWanandroidTheme(
    ...
    val colors = when (theme) {
        WanandroidTheme.LIGHT -> LightDefaultColorScheme
        WanandroidTheme.DARK -> DarkDefaultColorScheme
        WanandroidTheme.SYSTEM -> if (isSystemInDarkTheme()) DarkDefaultColorScheme else LightDefaultColorScheme
    }
